...
interface PackageRepositoryContract {
 ...
 /** @return array{items:array<InternetPackage>,total:int,page:int,perPage:int,lastPage:int} */ public function list(PackageListFilters $filters): array;
 ...
 public function changeStatus(int $id,string $status,int $userId): InternetPackage;
 public function softDelete(int $id): void;
 public function isInUse(int $id): bool;
 /** @return array<string,mixed> */ public function statistics(): array;
 /** @return array<int,array<string,mixed>> */ public function activity(int $id): array;
}
