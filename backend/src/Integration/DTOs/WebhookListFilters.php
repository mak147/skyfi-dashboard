...
final class WebhookListFilters
{
    public function __construct(
        public readonly ?int $clientApplicationId = null,
        public readonly ?bool $isActive = null,
        public readonly ?bool $isInbound = null,
    ...
    public static function fromQuery(array $query): self
    {
        ...
        return new self(
            ...
            isInbound: isset($query['is_inbound']) ? filter_var($query['is_inbound'], FILTER_VALIDATE_BOOLEAN, FILTER_NULL_ON_FAILURE) : null,
