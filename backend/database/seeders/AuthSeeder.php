...
final class AuthSeeder
{
    ...
    private function seedRolePermissions(PDO $connection, array $roleIds, array $permissionIds): void
    {
        $rolePermissions = [
            ...
            'Regional Manager' => ['field.view', 'field.create', 'field.update', 'field.assign', 'field.complete', 'field.manage', 'view:dashboard:regional', 'view:customer', 'view:invoice', 'view:payment', 'view:ticket', 'view:tower', 'view:report:regional', 'update:user:role', 'view:work-order', 'customers.view', 'customers.create', 'customers.update', 'customers.export', 'customers.manage', 'packages.view', 'packages.create', 'packages.update', 'packages.export', 'packages.manage', 'payments.view', 'payments.create', 'payments.update', 'payments.export', 'payments.manage'],
            ...
            'Sales Team' => ['manage:lead', 'execute:service-availability-check', 'create:quote', 'create:customer', 'view:customer:basic', 'view:service-plan', 'customers.view', 'customers.create', 'customers.update', 'packages.view', 'payments.view'],
            'Customer Support' => ['field.view', 'field.create', 'manage:ticket', 'support.view', 'support.create', 'support.update', 'support.assign', 'support.close', 'view:customer', 'update:customer:contact', 'update:customer:notes', 'view:invoice', 'view:payment', 'create:payment:manual', 'view:service', 'view:network-status:customer', 'execute:service:reconnect', 'customers.view', 'customers.update', 'packages.view', 'payments.view', 'payments.create', 'pppoe.view', 'pppoe.enable', 'pppoe.disable', 'pppoe.monitor'],
            'Installation Team / Field Technician' => ['field.view', 'field.update', 'field.complete', 'view:work-order:own', 'update:work-order:own', 'view:customer:contact_and_address', 'view:inventory:own-vehicle', 'execute:site-survey', 'execute:service:diagnostics', 'customers.view', 'packages.view', 'pppoe.view'],
            'Network Engineer' => ['field.view', 'field.create', 'field.update', 'manage:tower', 'manage:mikrotik-router', 'mikrotik.view', 'mikrotik.create', 'mikrotik.update', 'mikrotik.delete', 'mikrotik.connect', 'view:ip-address-pool', 'execute:provisioning:manual', 'execute:config-backup', 'view:network-status:global', 'view:customer:network-details', 'view:report:network', 'customers.view', 'customers.manage', 'packages.view', 'packages.update', 'packages.manage', 'pppoe.view', 'pppoe.create', 'pppoe.update', 'pppoe.delete', 'pppoe.enable', 'pppoe.disable', 'pppoe.sync', 'pppoe.monitor', 'pppoe.manage'],
            'Inventory Manager' => ['field.view', 'manage:inventory-item', 'manage:warehouse', 'execute:stock-transfer', 'inventory.view', 'inventory.create', 'inventory.update', 'inventory.delete', 'inventory.transfer', 'inventory.audit', 'inventory.manage', 'manage:vendor', 'vendors.view', 'vendors.create', 'vendors.update', 'vendors.delete', 'vendors.contracts', 'vendors.manage', 'manage:purchase-order', 'view:report:inventory', 'customers.view', 'packages.view'],
        ];
        $statement = $connection->prepare(
