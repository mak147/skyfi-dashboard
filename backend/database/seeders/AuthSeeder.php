...
final class AuthSeeder
{
    ...
    private function seedRolePermissions(PDO $connection, array $roleIds, array $permissionIds): void
    {
        $rolePermissions = [
            'Super Administrator' => ['*'],
            'Company Owner' => ['view:dashboard:company', 'view:report:financial', 'view:report:subscriber', 'view:report:network', 'view:audit-log', 'customers.view', 'customers.export', 'packages.view', 'packages.export', 'payments.view', 'payments.create', 'payments.update', 'payments.delete', 'payments.refund', 'payments.export', 'payments.manage'],
            'Regional Manager' => ['view:dashboard:regional', 'view:customer', 'view:invoice', 'view:payment', 'view:ticket', 'view:tower', 'view:report:regional', 'update:user:role', 'view:work-order', 'customers.view', 'customers.create', 'customers.update', 'customers.export', 'customers.manage', 'packages.view', 'packages.create', 'packages.update', 'packages.export', 'packages.manage', 'payments.view', 'payments.create', 'payments.update', 'payments.export', 'payments.manage'],
            'Finance Department' => ['manage:invoice', 'manage:payment', 'manage:credit', 'create:refund:small', 'create:refund:large', 'execute:billing-run', 'execute:dunning-process', 'manage:service-plan', 'view:customer', 'view:report:financial', 'customers.view', 'customers.export', 'packages.view', 'packages.create', 'packages.update', 'packages.delete', 'packages.export', 'packages.manage', 'payments.view', 'payments.create', 'payments.update', 'payments.delete', 'payments.refund', 'payments.export', 'payments.manage'],
            ...
            'Customer Support' => ['manage:ticket', 'support.view', 'support.create', 'support.update', 'support.assign', 'support.close', 'view:customer', 'update:customer:contact', 'update:customer:notes', 'view:invoice', 'view:payment', 'create:payment:manual', 'view:service', 'view:network-status:customer', 'execute:service:reconnect', 'customers.view', 'customers.update', 'packages.view', 'payments.view', 'payments.create', 'pppoe.view', 'pppoe.enable', 'pppoe.disable', 'pppoe.monitor'],
            'Installation Team / Field Technician' => ['view:work-order:own', 'update:work-order:own', 'view:customer:contact_and_address', 'view:inventory:own-vehicle', 'execute:site-survey', 'execute:service:diagnostics', 'customers.view', 'packages.view', 'pppoe.view'],
            'Network Engineer' => ['manage:tower', 'manage:mikrotik-router', 'mikrotik.view', 'mikrotik.create', 'mikrotik.update', 'mikrotik.delete', 'mikrotik.connect', 'view:ip-address-pool', 'execute:provisioning:manual', 'execute:config-backup', 'view:network-status:global', 'view:customer:network-details', 'view:report:network', 'customers.view', 'customers.manage', 'packages.view', 'packages.update', 'packages.manage', 'pppoe.view', 'pppoe.create', 'pppoe.update', 'pppoe.delete', 'pppoe.enable', 'pppoe.disable', 'pppoe.sync', 'pppoe.monitor', 'pppoe.manage'],
            'Inventory Manager' => ['manage:inventory-item', 'manage:warehouse', 'execute:stock-transfer', 'inventory.view', 'inventory.create', 'inventory.update', 'inventory.delete', 'inventory.transfer', 'inventory.audit', 'inventory.manage', 'manage:vendor', 'manage:purchase-order', 'view:report:inventory', 'customers.view', 'packages.view'],
        ];
        $statement = $connection->prepare(
